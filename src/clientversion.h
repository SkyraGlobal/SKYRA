...
#error Client version information missing: version is not defined by skyra-config.h or in any other way
#endif
...
/**
 * skyrad-res.rc includes this file, but it cannot cope with real c++ code.
