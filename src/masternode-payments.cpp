...
bool IsBlockPayeeValid(const CBlock& block, const CBlockIndex* pindexPrev)
{
    ...
    if (nBlockHeight == 50000 || nBlockHeight == 100000 || nBlockHeight == 150000 || nBlockHeight == 200000 || nBlockHeight == 300000 || nBlockHeight == 400000 || nBlockHeight == 500000 || nBlockHeight == 600000 || nBlockHeight == 700000 || nBlockHeight == 800000 || nBlockHeight == 1000000 || nBlockHeight == 1250000 || nBlockHeight == 1500000 || nBlockHeight == 2000000 || nBlockHeight == 2500000) {
    ...
    if (nBlockHeight == 49999 || nBlockHeight == 99999 || nBlockHeight == 149999 || nBlockHeight == 199999 || nBlockHeight == 299999 || nBlockHeight == 399999 || nBlockHeight == 499999 || nBlockHeight == 599999 || nBlockHeight == 699999 || nBlockHeight == 799999 || nBlockHeight == 999999 || nBlockHeight == 1249999 || nBlockHeight == 1499999 || nBlockHeight == 1999999 || nBlockHeight == 2499999) {
    ...
    if (nBlockHeight == 50201 || nBlockHeight == 100201 || nBlockHeight == 150201 || nBlockHeight == 200201 || nBlockHeight == 300201 || nBlockHeight == 400201 || nBlockHeight == 500201 || nBlockHeight == 600201 || nBlockHeight == 700201 || nBlockHeight == 800201 || nBlockHeight == 1000201 || nBlockHeight == 1250201 || nBlockHeight == 1500201 || nBlockHeight == 2000201 || nBlockHeight == 2500201) {
        SporkId nSporkID = sporkManager.GetSporkIDByName("SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT");
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txCoinbase, CMutableTransaction& txCoinstake, const CBlockIndex* pindexPrev, bool fProofOfStake) const
{
    ...
    // Starting from SKYRA v6.0 masternode and budgets are paid in the coinbase tx
