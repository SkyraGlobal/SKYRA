...
#include "qt/skyra/createproposaldialog.h"
#include "qt/skyra/forms/ui_createproposaldialog.h"

#include "qt/skyra/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(SKYRAGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.skyra/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 SKY");
