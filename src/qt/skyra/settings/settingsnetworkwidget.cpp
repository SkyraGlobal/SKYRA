...
#include "qt/skyra/settings/settingsnetworkwidget.h"
#include "qt/skyra/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/skyra/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SKYRAGUI* _window, QWidget *parent) :
