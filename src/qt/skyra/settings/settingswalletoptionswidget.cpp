...
#include "qt/skyra/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/skyra/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(SKYRAGUI* _window, QWidget *parent) :
