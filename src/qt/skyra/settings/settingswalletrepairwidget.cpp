...
#include "qt/skyra/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/skyra/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SKYRAGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SKYRAGUI::handleRestart()
