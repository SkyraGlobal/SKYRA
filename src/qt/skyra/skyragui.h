...
#ifndef SKYRA_CORE_NEW_GUI_SKYRAGUI_H
#define SKYRA_CORE_NEW_GUI_SKYRAGUI_H
...
#include "qt/skyra/navmenuwidget.h"
#include "qt/skyra/topbar.h"
#include "qt/skyra/dashboardwidget.h"
#include "qt/skyra/send.h"
#include "qt/skyra/receivewidget.h"
#include "qt/skyra/addresseswidget.h"
#include "qt/skyra/coldstakingwidget.h"
#include "qt/skyra/governancewidget.h"
#include "qt/skyra/masternodeswidget.h"
#include "qt/skyra/snackbar.h"
#include "qt/skyra/settings/settingswidget.h"
...
/**
  SKYRA GUI main class. This class represents the main window of the SKYRA UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SKYRAGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SKYRAGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~SKYRAGUI();
...
#endif //SKYRA_CORE_NEW_GUI_SKYRAGUI_H
