...
#include "qt/skyra/forms/ui_masternodeswidget.h"

#include "qt/skyra/qtutils.h"
#include "qt/skyra/mnrow.h"
#include "qt/skyra/mninfodialog.h"
#include "qt/skyra/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(SKYRAGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::SKY)));
        return;
    }
    showHideOp(true);
