...
#ifndef SKYRA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define SKYRA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //SKYRA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
