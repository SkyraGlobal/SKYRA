...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, SKYRAGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, SKYRAGUI* gui, double posX = 3);
