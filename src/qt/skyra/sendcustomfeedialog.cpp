...
#include "qt/skyra/sendcustomfeedialog.h"
#include "qt/skyra/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(SKYRAGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &SKYRAGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
