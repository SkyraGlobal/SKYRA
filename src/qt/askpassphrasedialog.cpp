...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            SKYRAGUI* window = static_cast<SKYRAGUI*>(parentWidget());
...
{
    SKYRAGUI* gui = static_cast<SKYRAGUI*>(parentWidget());
...
{
    hide();
    static_cast<SKYRAGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Your wallet is now encrypted. "
               "Remember that encrypting your wallet cannot fully protect "
               "your SKYs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
