...
/* SKYRA GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SKYRA"
#define QAPP_ORG_DOMAIN "skyra.org"
#define QAPP_APP_NAME_DEFAULT "SKYRA-Qt"
#define QAPP_APP_NAME_TESTNET "SKYRA-Qt-testnet"
