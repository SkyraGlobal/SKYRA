...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SKY);
    unitlist.append(mSKY);
    unitlist.append(uSKY);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SKY:
        return QString("skyra");
    case mSKY:
        return QString("mskyra");
    case uSKY:
        return QString::fromUtf8("uskyra");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZsky)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSKY)
{
    QSettings settings;
...
QString BitcoinUnits::floorWithUnitTopBar(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSKY)
{
    QSettings settings;
...
QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSKY)
{
