...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("skyra"), "SKYRA");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://skyra.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/skyra"));
    BOOST_CHECK(validateURL("https://foo.bar/skyra/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.skyra.com"));
