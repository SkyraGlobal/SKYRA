...
#ifndef SKYRA_WALLET_H
#define SKYRA_WALLET_H
...
static const CAmount DEFAULT_MIN_STAKE_SPLIT_THRESHOLD = 20 * COIN;
...
enum WalletFeature {
    ...
    FEATURE_PRE_SKYRA = 61000, // inherited version..
...
public:
     ...
     * SKYRA: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 SKY output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CSkyStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
