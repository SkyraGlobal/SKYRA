...
{
    const char* pszTimestamp = "US House passes crypto bill despite warnings from SEC";
    const CScript genesisOutputScript = CScript() << ParseHex("04c10c83b2303ddf322a7dcd62dc2815ac7d10db058214ce121ba72607d57ab7810c02c05b2aed04b4deb9c4b7cb26c92428d61e56ad42774ba5ba0a023b5ee0a4") << OP_CHECKSIG;
...
static MapCheckpoints mapCheckpoints = {
    {0, uint256S("0x000004ad6d00b7ea9c21a3551bd5e0078f7c8d7429f080bef66f29cde6b787a4")},
    {793, uint256S("0xbbcbde6dd3b4c53b165700116de89891cfe2fdc0315547feeff0c3924aa3e9e0")},
    {1503, uint256S("0x8118dcf782f7c8a5f5733dea5673852aeb892592c0f5beec1c783f50d6ad080d")},
    {3890, uint256S("0xef8713ad91adbf7fa5705f1be48d686cb6a7dedf4793f425f95f65c619af49ef")},
    {4298, uint256S("0xe1bb0690601b18b958fa6c724628d7c1690ad50cd19fdf6cba5b8bc825b25a3a")},
    {7201, uint256S("0x8d496f244a096c2ca6a7eb0b1ac36083f2783761c405058380cb7f34764317b0")},
};

static const CCheckpointData data = {
    &mapCheckpoints,
    1716966720, // * UNIX timestamp of last checkpoint block
    14483,      // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1716459105, 695915, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000004ad6d00b7ea9c21a3551bd5e0078f7c8d7429f080bef66f29cde6b787a4"));
        assert(genesis.hashMerkleRoot == uint256S("0x6195fa21a42d4594375d5b392855b894ce62fcf70639d14da1025ae326d8435a"));
        ...
        consensus.nMaxMoneyOut = 11000000 * COIN;
        ...
        // spork keys
        consensus.strSporkPubKey = "04efbbee90faace6d7d4b5a44d0116038ac96b507f1f971a028df835927caa225d918c0027ade3fa6897cc7293b9a2e541b4e0777179253b3ebdd4102051798bc4";
        consensus.strSporkPubKeyOld = "04efbbee90faace6d7d4b5a44d0116038ac96b507f1f971a028df835927caa225d918c0027ade3fa6897cc7293b9a2e541b4e0777179253b3ebdd4102051798bc4";
        consensus.nTime_EnforceNewSporkKey = 1716441608; //!> Thursday, May 23, 2024 5:20:08 AM
        consensus.nTime_RejectOldSporkKey = 1716704480;  //!> Sunday, May 26, 2024 6:21:20 AM
        ...
        vSeeds.emplace_back("164.90.220.24", true);
        vSeeds.emplace_back("188.166.251.215", true);
        vSeeds.emplace_back("152.42.218.7", true);
        vSeeds.emplace_back("152.42.192.40", true);
        vSeeds.emplace_back("188.166.251.23", true);
        vSeeds.emplace_back("152.42.208.29", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 63); // starting with 'S'
        ...
        // Sapling
        bech32HRPs[SAPLING_PAYMENT_ADDRESS]      = "sk";
        bech32HRPs[SAPLING_FULL_VIEWING_KEY]     = "pviews";
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "skyks";
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("skyra-testnet.seed.fuzzbawls.pw", true);
        vSeeds.emplace_back("skyra-testnet.seed2.fuzzbawls.pw", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet skyra addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet skyra script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet skyra BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet skyra BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0x3a, 0x80, 0x58, 0x37};
        // Testnet skyra BIP44 coin type is '1' (All coin's testnet default)
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "skyktestsapling";
