...
extern const char * const SKYRA_CONF_FILENAME;
extern const char * const SKYRA_PID_FILENAME;
extern const char * const SKYRA_MASTERNODE_CONF_FILENAME;
