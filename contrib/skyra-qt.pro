...
RESOURCES += src/qt/skyra.qrc src/qt/skyra_locale.qrc

TRANSLATIONS += src/qt/locale/skyra_bg.ts \
                src/qt/locale/skyra_de.ts \
                src/qt/locale/skyra_en.ts \
                src/qt/locale/skyra_es.ts \
                src/qt/locale/skyra_fi.ts \
                src/qt/locale/skyra_fr.ts \
                src/qt/locale/skyra_it.ts \
                src/qt/locale/skyra_ja.ts \
                src/qt/locale/skyra_pl.ts \
                src/qt/locale/skyra_pt.ts \
                src/qt/locale/skyra_ru.ts \
                src/qt/locale/skyra_sk.ts \
                src/qt/locale/skyra_sv.ts \
                src/qt/locale/skyra_vi.ts \
                src/qt/locale/skyra_zh_CN.ts \
                src/qt/locale/skyra_zh_TW.ts
