Contributing to SKYRA Core
============================

The SKYRA Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/skyra-project/skyra/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SKYRA Core project, and is not to be
confused with overall SKYRA Network Protocol consensus changes.

Whether a pull request is merged into SKYRA Core rests with the project merge
...
Patches that change SKYRA consensus rules are considerably more involved than
...
Where a patchset proposes to change the SKYRA consensus, it must have been
...
The project leader is the release manager for each SKYRA Core release.
