...
class ListReceivedTest (SKYRATestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 SKY.
        ...
        # Send 1 SKY to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 SKY sending them all (fee is 0.1 SKY)
        ...
        # Confirm transaction (2 SKY from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 SKY, send 0.6 SKY + 0.05 SKY fee
