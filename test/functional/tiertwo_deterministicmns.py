...
class DIP3Test(SKYRATestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 SKY) to the operator, and (2 * 2.7 SKY) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid SKYRA address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid SKYRA address InvalidPayee", controller.protx_update_registrar,
