...
class FullBlockTest(SKYRATestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure skyrad isn't accepting b26
        ...
        # Extend the b28 chain to make sure skyrad isn't accepting b28
        ...
        # SKYRA: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the skyra code has custom code which does so);
