...
By default, skyrad will dump mempool on shutdown and
...
class MempoolPersistTest(SKYRATestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent skyrad from writing mempool.dat to disk. Verify that `savemempool` fails")
