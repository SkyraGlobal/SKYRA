...
COIN = 100000000 # 1 SKY in satoshis
...
# Objects that map to skyrad objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in skyrad indicates these should be deserialized as blocks
