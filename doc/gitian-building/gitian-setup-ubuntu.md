...
The build script we'll be using is contained in the SKYRA github repository ([contrib/gitian-build.py](https://github.com/skyra-project/skyra/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the SKYRA repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/SKYRA-Project/SKYRA/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, skyra-detached-sigs, and skyra GitHub repos.
