SKYRA Core version v5.1.0 is now available from:  <https://github.com/skyra-project/skyra/releases>
...
- #2170 Better skyra.conf Masternode data error notification (furszy)
