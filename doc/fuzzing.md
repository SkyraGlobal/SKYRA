...
To build SKYRA Core using AFL instrumentation (this assumes that the
...
with certain assembly code from SKYRA Core's code. See [developer notes on sanitizers](https://github.com/SKYRA-Project/SKYRA/blob/master/doc/developer-notes.md#sanitizers)
